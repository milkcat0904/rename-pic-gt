...
for item in seq_names :
    ...
    for nums in seq_nums:
        ...
        images_path =  os.path.join('subset_new', item, nums, 'labels')+'/'
        ...
        for i in images :
            ...
            i=int(i)
            if i<=10:
                newname =  images_path+'0000'+str(i)+'.bmp'
            elif i>100 :
                newname = images_path + '00' + str(i)+'.bmp'
            else:
                newname = images_path + '000'+str(i)+'.bmp'
